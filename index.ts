import { aiddDomain, type AiddDomain } from './ts/aiddDomain.keys'
import { aiddTaskStatus, type AiddTaskStatus } from './ts/aiddTaskStatus.keys'
import { aiddTaskType, type AiddTaskType } from './ts/aiddTaskType.keys'
...
import { school, type School } from './ts/school.keys'
import { schoolSystem_DE, type SchoolSystemDe } from './ts/schoolSystem_DE.keys'
import { sharedProperty, type SharedProperty } from './ts/sharedProperty.keys'
import { sharedPropertyScope, type SharedPropertyScope } from './ts/sharedPropertyScope.keys'
